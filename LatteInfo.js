...
export default class LatteInfo extends Component {
...
price() {
  ...
  if (this.state.selectedColor != 'None'){
      ...
      if (this.state.selectedSize == 'Small - 12 oz'){
        value = this.state.quantity * (3.40 + extras);
      }
   ...
   if (this.state.selectedColor == 'None')  {
     if (this.state.selectedSize == 'Short - 8 oz'){
        value = this.state.quantity * (2.35 + extras);
    }
    if (this.state.selectedSize == 'Small - 12 oz'){
        value = this.state.quantity * (3.05 + extras);
    }
    if (this.state.selectedSize == 'Medium - 16 oz'){
