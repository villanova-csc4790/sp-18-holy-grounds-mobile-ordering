...
export default class IcedLatteInfo extends Component {
  ...
  render() {
    ...
    return(
      <Container style={{backgroundColor: '#fdfdfd'}}>
        ...
        <Content>
            <Image source={require('./Iced Drinks/IcedLatte.jpg')} style={styles.image} />
...
price() {
    ...
    if (this.state.selectedColor != 'None'){
      if (this.state.selectedSize == 'Small - 16 oz'){
        value = this.state.quantity * (3.80 + extras);
      }
