...
export default class MatchaLatteInfo extends Component {
  ...
  render() {
    ...
    return(
      <Container style={{backgroundColor: '#fdfdfd'}}>
        ...
        <Content>
            <Image source={require('./Hot Drinks/MatchaLatte.jpg')} style={styles.image} />
 ...
 if (this.state.selectedextraflavor == 'Yes'){
  ...
  if (this.state.selectedColor != 'None'){
      ...
      if (this.state.selectedSize == 'Medium - 16 oz'){
        value = this.state.quantity * (4.10 + extras);
      }
      if (this.state.selectedSize == 'Large - 24 oz'){
      value = this.state.quantity * (4.55 + extras);
      }
   }
   if (this.state.selectedColor == 'None')  {
     if (this.state.selectedSize == 'Short - 8 oz'){
    ...
    if (this.state.selectedSize == 'Small - 12 oz'){
        value = this.state.quantity * (3.20 + extras);
    }
    if (this.state.selectedSize == 'Medium - 16 oz'){
        value = this.state.quantity * (3.70 + extras);
    }
    if (this.state.selectedSize == 'Large - 24 oz'){
      value = this.state.quantity * (4.10 + extras);
    }
